...
export const Form = () => {
    ...
    return (
        <div className="w-3/6 h-[580px] flex flex-col justify-center items-center bg-red-700 bg-opacity-90 text-center p-2 rounded-[20px] max-[1260px]:mt-60 max-[1260px]:mb-8 max-[1260px]:h-[765px] max-[900px]:h-[800px] max-[900px]:mt-28 max-[500px]:w-[300px] max-[500px]:h-[900px] max-[500px]:mt-60">
            ...
            <form onSubmit={handleSubmit(formUser)} autoComplete="off">
                <fieldset className="h-[430px] flex flex-col items-start gap-8 p-4 border border-gray-200 text-left mt-2 mx-2 max-[1260px]:h-[620px] max-[900px]:h-[640px] max-[425px]:w-[260px] max-[425px]:p-2 max-[500px]:h-[730px]">
                    ...
                    <div className="flex flex-col text-center h-6 max-[1260px]:h-8 max-[1060px]:h-6 max-[900px]:mb-6  max-[500px]:gap-1 max-[500px]:mb-8">
                    ...
                    <div className="flex flex-col text-center h-8 mt-2 max-[1260px]:mt-0 max-[900px]:mb-3 max-[500px]:mt-1 max-[500px]:mb-0">
                    ...
                    <div className="flex h-6 max-[1260px]:flex-col gap-6 max-[1260px]:h-12 max-[1260px]:mb-10 max-[1060px]:mt-3 max-[500px]:gap-10 max-[500px]:mb-20">
                        <div className="flex flex-col max-[1260px]:h-10">
                    ...
                    <div className="flex gap-10 h-6 mt-4 max-[1260px]:flex-col max-[1260px]:gap-6 max-[1260px]:mt-1">
                        ...
                        <div className="flex flex-col text-center h-10 max-[500px]:items-center">
                            <div className="max-[1260px]:h-12">
                                <div className="max-[500px]:flex flex-col items-start">
